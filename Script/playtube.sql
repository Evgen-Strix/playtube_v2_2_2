...
(803, 'contain_lowercase', '', 'Must contain a lowercase letter.', 'يجب أن تحتوي على حرف صغير.', 'Moet een kleine letter bevatten.', 'Doit contenir une lettre minuscule.', 'Muss einen Kleinbuchstaben enthalten.', 'Должен содержать строчную букву.', 'Debe contener una letra minúscula.', 'Küçük bir harf içermelidir.'),
(804, 'contain_uppercase', '', 'Must contain an uppercase letter.', 'يجب أن تحتوي على حرف كبير.', 'Moet een hoofdletter bevatten.', 'Doit contenir une lettre majuscule.', 'Muss einen Großbuchstaben enthalten.', 'Должен содержать заглавную букву.', 'Debe contener una letra mayúscula.', 'Bir büyük harf içermeli.'),
...
(808, 'invitation_links', '', 'Invitation Links', 'روابط الدعوة', 'Uitnodigingslinks', 'Liens d\'invitation', 'Einlagenlinks', 'Пригласительные ссылки', 'Enlaces de invitación', 'Davet Bağlantıları'),
(809, 'unlimited', '', 'Unlimited', 'غير محدود', 'Onbeperkt', 'Illimité', 'Unbegrenzt', 'Неограниченный', 'Ilimitado', 'Sınırsız'),
(810, 'available_links', '', 'Available Links', 'الروابط المتاحة', 'Beschikbare links', 'Liens disponibles', 'Verfügbare Links', 'Доступные ссылки', 'Enlaces disponibles', 'Mevcut bağlantılar'),
(811, 'generated_links', '', 'Generated Links', 'روابط تم إنشاؤها', 'Gegenereerde links', 'Liens générés', 'Erzeugte Links', 'Сгенерированные ссылки', 'Enlaces generados', 'Oluşturulan bağlantılar'),
(812, 'used_links', '', 'Used Links', 'الروابط المستخدمة', 'Gebruikte links', 'Liens d\'occasion', 'Gebrauchte Links', 'Использовали ссылки', 'Enlaces usados', 'Kullanılmış bağlantılar'),
(813, 'generate_link', '', 'Generate Links', 'توليد روابط', 'Genereer links', 'Générer des liens', 'Links generieren', 'Генерировать ссылки', 'Generar enlaces', 'Bağlantılar Oluşturun'),
(814, 'code_successfully', '', 'Code successfully generated', 'تم إنشاء الكود بنجاح', 'Code met succes gegenereerd', 'Code généré avec succès', 'Code erfolgreich generiert', 'Код успешно сгенерирован', 'Código generado con éxito', 'Kod başarıyla oluşturuldu'),
(815, 'copy', '', 'Copy', 'ينسخ', 'Kopiëren', 'Copie', 'Kopieren', 'Копия', 'Copiar', 'Kopya'),
(816, 'copied', '', 'Copied', 'نسخ', 'Gekopieerd', 'Copié', 'Kopiert', 'Скопированный', 'Copiado', 'Kopyalanmış'),
(817, 'url', '', 'Url', 'عنوان URL', 'Url', 'URL', 'URL', 'URL', 'Url', 'Url'),
(818, 'invited_user', '', 'Invited User', 'المستخدم المستخدم', 'Uitgenodigde gebruiker', 'Utilisateur invité', 'Eingeladener Benutzer', 'Приглашенный пользователь', 'Usuario invitado', 'Davet edilen kullanıcı'),
(819, 'date', '', 'Date', 'تاريخ', 'Datum', 'Date', 'Datum', 'Свидание', 'Fecha', 'Tarih'),
(820, 'shorts_maximum_duration_allow', '', 'Please note that maximum duration allow is {X} seconds.', 'يرجى ملاحظة أن الحد الأقصى المدة السماح هو {x} ثانية.', 'Houd er rekening mee dat maximale duur {x} seconden is.', 'Veuillez noter que la durée maximale est {x} secondes.', 'Bitte beachten Sie, dass die maximale Dauer {x} Sekunden beträgt.', 'Обратите внимание, что максимальная продолжительность разрешения составляет {x} секунд.', 'Tenga en cuenta que el permiso de duración máxima es {x} segundos.', 'Maksimum süre izin vermenin {x} saniye olduğunu lütfen unutmayın.'),
(821, 'crop_the_video', '', 'Cut The Video', 'قطع الفيديو', 'Snijd de video', 'Couper la vidéo', 'Schneiden Sie das Video', 'Вырежьте видео', 'Cortar el video', 'Videoyu kes'),
(822, 'skip_ad', '', 'Skip Ad', 'تجاهل الاعلانات', 'Advertentie overslaan', 'Passer la pub', 'Überspringen', 'Пропустить рекламу', 'Omitir aviso publicitario', 'Reklamı geç'),
(823, 'manage_my_movies', '', 'Manage My Movies', 'إدارة أفلامي', 'Beheer mijn films', 'Gérer mes films', 'Verwalten Sie meine Filme', 'Управляйте моими фильмами', 'Administra mis películas', 'Filmlerimi yönet'),
(824, 'saturday', '', 'Saturday', 'السبت', 'zaterdag', 'Samedi', 'Samstag', 'Суббота', 'sábado', 'Cumartesi'),
(825, 'sunday', '', 'Sunday', 'الأحد', 'Zondag', 'Dimanche', 'Sonntag', 'Воскресенье', 'Domingo', 'Pazar'),
(826, 'monday', '', 'Monday', 'الاثنين', 'Maandag', 'Lundi', 'Montag', 'Понедельник', 'Lunes', 'Pazartesi'),
(827, 'tuesday', '', 'Tuesday', 'يوم الثلاثاء', 'Dinsdag', 'Mardi', 'Dienstag', 'Вторник', 'martes', 'Salı'),
(828, 'wednesday', '', 'Wednesday', 'الأربعاء', 'Woensdag', 'Mercredi', 'Mittwoch', 'Среда', 'miércoles', 'Çarşamba'),
(829, 'thursday', '', 'Thursday', 'يوم الخميس', 'Donderdag', 'Jeudi', 'Donnerstag', 'Четверг', 'jueves', 'Perşembe'),
(830, 'friday', '', 'Friday', 'جمعة', 'Vrijdag', 'Vendredi', 'Freitag', 'Пятница', 'Viernes', 'Cuma'),
(831, 'january', '', 'January', 'يناير', 'Januari', 'Janvier', 'Januar', 'Январь', 'enero', 'Ocak'),
(832, 'february', '', 'February', 'شهر فبراير', 'Februari', 'Février', 'Februar', 'Февраль', 'Febrero', 'Şubat'),
(833, 'march', '', 'March', 'يمشي', 'Maart', 'Mars', 'Marsch', 'Маршировать', 'Marzo', 'Mart'),
(834, 'april', '', 'April', 'أبريل', 'april', 'Avril', 'April', 'апреля', 'Abril', 'Nisan'),
(835, 'may', '', 'May', 'مايو', 'Kunnen', 'Peut', 'Kann', 'Май', 'Mayo', 'Mayıs'),
(836, 'june', '', 'June', 'يونيه', 'juni-', 'Juin', 'Juni', 'Июнь', 'Junio', 'Haziran'),
(837, 'july', '', 'July', 'يوليو', 'juli-', 'Juillet', 'Juli', 'Июль', 'Julio', 'Temmuz'),
(838, 'august', '', 'August', 'أغسطس', 'augustus', 'Août', 'August', 'Август', 'Agosto', 'Ağustos'),
(839, 'september', '', 'September', 'سبتمبر', 'september', 'Septembre', 'September', 'Сентябрь', 'Septiembre', 'Eylül'),
(840, 'october', '', 'October', 'اكتوبر', 'oktober', 'Octobre', 'Oktober', 'Октябрь', 'Octubre', 'Ekim'),
(841, 'november', '', 'November', 'شهر نوفمبر', 'November', 'Novembre', 'November', 'Ноябрь', 'Noviembre', 'Kasım'),
(842, 'december', '', 'December', 'ديسمبر', 'December', 'Décembre', 'Dezember', 'Декабрь', 'Diciembre', 'Aralık');
...
CREATE TABLE `users` (
  ...
  `StripeSessionId` varchar(300) CHARACTER SET utf8 DEFAULT NULL,
  `securionpay_key` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '',
