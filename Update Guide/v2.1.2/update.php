...
if (!empty($_POST['update_langs'])) {
    @unlink("./deleted_youtube.php");
    @unlink("./themes/default/js/stripe.js");
    @unlink("./themes/youplay/js/stripe.js");
    deleteDir("./assets/import/onesignal");
            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.1.2 </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                          <li>[Added] Video Cleaner (Clean your database from outdated youtube, daily and vimeo videos) To Admin -> Tools.</li>
                          <li>[Fixed] autoplay on page load.</li>
                          <li>[Fixed] Firefox login issue.</li>
                          <li>[Fixed] player not playing none ffmpeg videos. </li>
                          <li>[Fixed] scheduled video date, it was showing the upload date instead.</li>
                          <li>[Fixed] video player responsivity.</li>
                        </ul>
