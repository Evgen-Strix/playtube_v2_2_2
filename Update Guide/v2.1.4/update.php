            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.1.4 </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                          <li>[Fixed] maintenance mode page in youplay theme.</li>
                          <li>[Fixed] upload showing "undefined" using ffmpeg. </li>
                          <li>[Fixed] system adding users as CC in newsletter.</li>
                          <li>[Fixed] important security XSS exploit.</li>
                        </ul>
